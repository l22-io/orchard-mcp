...
export function registerKeynoteTools(server: McpServer): void {
  ...
  server.tool(
    ...
    {
      file: z.string().describe("Path to the Keynote file"),
      slide: z
        .number()
        .optional()
  ...
  server.tool(
    ...
    {
      file: z.string().describe("Path for the new Keynote file"),
      theme: z
        .string()
        .optional()
  ...
  server.tool(
    ...
    {
      file: z.string().describe("Path to the Keynote file"),
      slide: z.number().describe("Slide index to edit (1-based)"),
  ...
  server.tool(
    ...
    {
      file: z.string().describe("Path to the Keynote file"),
      from: z.number().describe("Current slide index (1-based)"),
      to: z.number().describe("Target slide index (1-based)"),
    },
    async ({ file, from, to }) => {
      const data = await bridgeData([
